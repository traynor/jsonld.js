...
api.expand = async ({
  ...
  // store context used
  //console.log('todo: jsonld move from nm: check mapped prefixes', activeProperty, expandedActiveProperty);
  contextStore.addContext(activeProperty, expandedActiveProperty);
